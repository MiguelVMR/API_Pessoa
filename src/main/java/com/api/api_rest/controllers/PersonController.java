...
public class PersonController {
	...
	@CrossOrigin(origins = {"http://localhost:8080", "http://miguel.com.br"})
	...
	@Operation(summary = "Deletes a  new Person", description = "Deletes a  new Person by passing in a JSON, XML or YML representation of the person!",
	 tags = {"People"},
	  responses = {
					@ApiResponse(description = "No content", responseCode = "204", content = @Content),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
